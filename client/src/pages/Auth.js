...
const Auth = () => {
    ...
    return (
        ...
        >
            <div className="h-screen py-60 md:py-0 max-w-screen-xl mx-auto flex items-center justify-center">
                <div className="p-8 drop-shadow-2xl">
                    <img src={icon} alt="/" className="w-16 mx-auto" />
                    <h1 className="uppercase text-4xl font-semibold text-center md:text-5xl drop-shadow-2xl">
                        CookBook
                    </h1>
